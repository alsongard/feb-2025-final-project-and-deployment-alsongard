...
export default function TechInfoComponent(props: any)
{
    return (
        <div>
            <div className="tech-info-container relative h-full w-[400px] flex-shrink-0 flex-grow-0 p-[1px] shadow-[0_0_5px_3px_#5d6d7e] flex flex-col justify-center rounded-[10px]">
